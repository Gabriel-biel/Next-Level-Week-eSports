    ...
    <Dialog.Portal>
      <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
          ...
          <Dialog.Title className='text-3xl font-black'>Publique um Anúncio</Dialog.Title>
            <form onSubmit={handleCreatedAd} className='mt-8 flex flex-col gap-4'>
              ...
              <footer className='mt-4 flex justify-end gap-4'>
                ...
                <button
                  type='submit' 
                  className='bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3bg-violet-600'>
        ...
        <Toast.Provider swipeDirection="right" duration={5000}>
          <Toast.Viewport className="flex justify-end mr-6 mt-10">
            <Toast.Root open={alertToast} className="flex flex-col p-2 w-1/5 h-20 items-center justify-center bg-violet-500 rounded-md text-lg">
              <Toast.Title>
                <p className="text-white font-semibold">Preencha Todos os Campos!</p>
              </Toast.Title>
              <Toast.Action altText="close" className="w-28">
                <p 
                  onClick={() =>{SetAlertToast(false)}}
                  className="bg-green-300 rounded-md p-1 text-white font-semibold">
                  Fechar
                </p>
              </Toast.Action>
            </Toast.Root>
